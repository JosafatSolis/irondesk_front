...
export default class TicketCard extends Component {
  render() {
    return (
      <div style={{ border: 'solid 2px #f07e1c' }}
        ...
        <section
          ...
          <article style={{ display: "flex", textAlign: "initial" }}>
            ...
            <div className="uk-margin-small-left">{this.props.tecnicianName}</div>    <hr/>
          </article>
          ...
          <article className="container-fluid" style={{ textAlign: "initial" }}>
            <ul uk-accordion="multiple: true">
              <li className="uk-closed">
                <button className="uk-accordion-title uk-button uk-button-muted uk-width-1-1">Descripción</button>
                      ...
                      <header className="uk-comment-header uk-grid-medium uk-flex-middle">
                        <div className="uk-width-expand">
                            ...
                            <h6 className="uk-comment-title uk-margin-remove">
                              <span uk-icon="user"></span> <span>{this.props.user}</span>
                            </h6>

                            <span> {dayjs(this.props.reportDate).format("D/MM/YYYY h:mm a")}  </span>
                        </div>
                      </header>
                    
                      <div className="uk-comment-body uk-text-justify"> <p>{this.props.description}</p>   </div>
                  </article>
                </div>
          ...
          <section className="container-fluid" style={{ textAlign: "initial" }}>
            <ul uk-accordion="multiple: true">
                <li className="uk-closed">
                <button className="uk-accordion-title uk-button uk-button-muted uk-width-1-1">Actividades</button>
                ...
                <div className="uk-accordion-content">
                    ...
                    <article>
                      <ul className="uk-iconnav uk-align-right">
                        <li className="uk-margin-small-top"> <button uk-icon="icon: plus-circle"></button> </li>
                      </ul>
                    </article>  
                </div>
          ...
          <div className="">
              <div className="uk-align-center"> <button className="uk-button uk-button-default">Validar</button>  </div>
              <div className="uk-align-center"> <button className="uk-button uk-button-default">Cerrar</button>   </div>
          </div>
